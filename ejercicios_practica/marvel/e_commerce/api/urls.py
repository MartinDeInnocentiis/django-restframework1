...
urlpatterns = [
    ...
    path('comic-filter/', comic_list_filtered_api_view, name='comic_list_filtered_api_view'),
    path('comic-premium/', comic_list_advanced_filter_api_view, name='comic_list_advanced_filter_api_view')
]